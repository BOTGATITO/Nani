...
const smsAvisoRG = () => { return `*𝚁𝙴𝚂𝚄𝙻𝚃𝙰𝙳𝙾*✅\n\n` } 
const smsAvisoAG = () => { return `𝙰𝙳𝚅𝙴𝚁𝚃𝙴𝙽𝙲𝙸𝙰 ⚠️\n\n` }
const smsAvisoIIG = () => { return `*𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝙲𝙸𝙾𝙽* ❕\n\n` }
const smsAvisoFG = () => { return `*𝙴𝚁𝚁𝙾𝚁* ❌\n\n` }
const smsAvisoMG = () => { return `*𝙰𝙲𝙲𝙸𝙾𝙽 𝙼𝙰𝙻 𝚄𝚂𝙰𝙳𝙰* ❗\n\n` }
const smsAvisoEEG = () => { return `*𝚁𝙴𝙿𝙾𝚁𝚃𝙴*📩\n\n` }
const smsAvisoEG = () => { return `*𝙾𝚁𝙳𝙴𝙽𝙴𝚂 𝚁𝙴𝙲𝙸𝙱𝙸𝙳𝙰𝚂*✅\n\n` }

const smsRowner = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂Ó𝙻𝙾 𝙴𝙻 𝙽Ú𝙼𝙴𝚁𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!!\`\`\`` }
const smsOwner = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁(𝙰) 𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚄𝚂𝙰𝚁!!\`\`\`` }
const smsMods = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙼𝙾𝙳𝙴𝚁𝙰𝙳𝙾𝚁𝙴𝚂 𝚈 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁(𝙰) 𝙻𝙾 𝙿𝚄𝙴𝙳𝙴𝙽 𝚄𝚂𝙰𝚁!!\`\`\`\`` }
const smsPremium = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙴𝚂𝚃𝙰 𝙳𝙸𝚂𝙿𝙾𝙽𝙸𝙱𝙻𝙴 𝙿𝙰𝚁𝙰 𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝚈 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁!! \n𝙿𝙸𝙳𝙰𝙻𝙴 𝙰𝙻 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝚀𝚄𝙴 𝙻𝙾 𝙸𝙽𝚃𝙴𝙶𝚁𝙴 𝙰 𝙻𝙰 𝙻𝙸𝚂𝚃𝙰 𝚅𝙸𝙿!!\`\`\`` }
const smsGroup = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝚁 𝙴𝙽 𝙶𝚁𝚄𝙿𝙾𝚂!!\`\`\`` }
const smsPrivate = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝚂𝙴 𝙿𝚄𝙴𝙳𝙴 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝚁 𝙰𝙻 𝙿𝚁𝙸𝚅𝙰𝙳𝙾!!\`\`\`` }
const smsAdmin = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙴𝚂 𝙿𝙰𝚁𝙰 𝙰𝙳𝙼𝙸𝙽𝚂!!\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`¡¡𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙾 𝚂𝙴𝚁 𝙰𝙳𝙼𝙸𝙽 𝙿𝙰𝚁𝙰 𝚀𝚄𝙴 𝙿𝚄𝙴𝙳𝙰𝚂 𝚄𝚂𝙰𝚁 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾!!\`\`\`` }
const smsUnreg = () => { return `\`\`\`¡¡𝙿𝙰𝚁𝙰 𝙴𝙻 𝚄𝚂𝙾 𝙳𝙴 𝙻𝙾𝚂 𝙲𝙾𝙼𝙰𝙽𝙳𝙾𝚂 𝙽𝙴𝙲𝙴𝚂𝙸𝚃𝙰𝚂 𝙴𝚂𝚃𝙰𝚁 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾, 𝙴𝚂𝙲𝚁𝙸𝙱𝙴 .verificar 𝙿𝙰𝚁𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝚁𝚃𝙴!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂𝚃𝙰 𝚁𝙴𝚂𝚃𝚁𝙸𝙽𝙶𝙸𝙳𝙾 𝙿𝙾𝚁 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁𝙰(𝙰)!!\`\`\`` }

//main.js
const smsWelcome = () => { return `*╭┈≫* @subject *≪┈ ✦*\n*┊➤ 𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗𝗢(𝗔)!!*\n┊➤ @user\n┊📄 *𝙻𝙴𝙰 𝙻𝙰 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ➚*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈≫*\n┊ *@user*\n┊ *(-𝟭) 𝗔𝗗𝗢𝗥𝗡𝗢 𝗘𝗡 𝗡𝗨𝗘𝗦𝗧𝗥𝗢 𝗚𝗥𝗨𝗣𝗢,* \n*┊ INSERVIBLE 🤮!!* \n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈≫*'}
const smsSpromote = () => { return '*@user 𝙷𝙰 𝚂𝙸𝙳𝙾 𝙰𝚂𝙲𝙴𝙽𝙳𝙸𝙳𝙾 𝙲𝙾𝙼𝙾 𝙰𝙳𝙼𝙸𝙽 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!!*'}
const smsSdemote = () => { return '*@user 𝙷𝙰 𝚂𝙸𝙳𝙾 𝙳𝙴𝙶𝚁𝙰𝙳𝙰𝙳𝙾 𝙲𝙾𝙼𝙾 𝙰𝙳𝙼𝙸𝙽 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!!*'}
const smsSdesc = () => { return '*𝙲𝙾𝙽𝙾𝚉𝙲𝙰𝙽 𝙻𝙰 𝙽𝚄𝙴𝚅𝙰 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾:*\n\n@desc'}
const smsSsubject = () => { return '*𝚂𝙴 𝙷𝙰 𝙰𝙲𝚃𝚄𝙰𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!!*\n@subject'}
const smsSicon = () => { return '*𝚂𝙴 𝙷𝙰 𝙰𝙲𝚃𝚄𝙰𝙻𝙸𝚉𝙰𝙳𝙾 𝙻𝙰 𝙵𝙾𝚃𝙾 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!!*'}
const smsSrevoke = () => { return '*𝙲𝙾𝙽𝙾𝚉𝙲𝙰𝙽 𝙴𝙻 𝙽𝚄𝙴𝚅𝙾 𝙴𝙽𝙻𝙰𝙲𝙴 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾!!*\n*@revoke*'}
...
const smsCreC = () => { return 'Te presento a mi dueño, siempre con la disposición de ayudarte 🤖'}
...
//info-donar.js
const smsMensajeDonar = () => { return `*_Se acepta apoyo voluntario por PayPal, si deseas apoyar de otra forma puedes informarnos al https://wa.me/573178206163_*!!\n\n *_Nos esforzamos a diario para ti\n⭐⭐⭐⭐⭐_*`}
const smsTituloDonar = () => { return '*🚀 𝙳𝙾𝙽𝙰𝙲𝙸𝙾𝙽 𝚅𝙾𝙻𝚄𝙽𝚃𝙰𝚁𝙸𝙰 💸*'}
const smsPrivadoDonar = () => { return '🧸 *_También puedes seguirnos como muestra de Apoyo_*'}
...
//grupo-tagall.js
const smstagaa = () => { return `🧑🏻‍🦯 *EL MEJOR BOT DE ALTA CALIDAD  , CONTACTANOS*
https://wa.me/593984036115
https://wa.me/+50767424947

Activense todos ya es hora ⏰`}
...
//rpg-perfil.js
const smsPerfil0 = () => { return `👤 *𝙿𝙴𝚁𝙵𝙸𝙻 𝙳𝙴𝙻 𝚄𝚂𝚄𝙰𝚁𝙸𝙾* 👤`}
const smsPerfil1 = () => { return `𝚄𝚂𝚄𝙰𝚁𝙸𝙾`}
const smsPerfil2 = () => { return `𝙽𝙾𝙼𝙱𝚁𝙴`}
const smsPerfil3 = () => { return `𝙴𝙳𝙰𝙳`}
const smsPerfil4 = () => { return `𝙽𝚄𝙼𝙴𝚁𝙾`}
const smsPerfil5 = () => { return `𝙸𝙳 𝙳𝙴 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙾:`}

//rpg-verificar.js
const smsVerify0 = (usedPrefix) => { return `${lenguajeGB['smsAvisoIIG']()}*YA ESTAS REGISTRADO(A)!!*\n*PARA ANULAR SU REGISTRO USE*\n*${usedPrefix}unreg numero de serie*\n\n*SI NO RECUERDA SU NS USE*\n*${usedPrefix}myns`}
const smsVerify1 = (usedPrefix, command) => { return `${lenguajeGB['smsAvisoIIG']()}*INGRESE SU NOMBRE Y EDAD PARA ESTAR REGISTRADO*\n⬇ *EJEMPLO* ⬇\n\n${usedPrefix + command} Nanibot.22`}
...
const smsVerify7 = () => { return `✅ *𝚅 𝙴 𝚁 𝙸 𝙵 𝙸 𝙲 𝙰 𝙲 𝙸 𝙾 𝙽* ✅`}
const smsVerify8 = (usedPrefix) => { return `*𝚂𝚄 𝙸𝙳 𝙳𝙴 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙾 𝚂𝙴𝚁𝚅𝙸𝚁𝙰 𝙴𝙽 𝙲𝙰𝚂𝙾 𝚀𝚄𝙴 𝙳𝙴𝚂𝙴𝙴 𝙼𝙾𝙳𝙸𝙵𝙸𝙲𝙰𝚁 𝙾 𝙴𝙻𝙸𝙼𝙸𝙽𝙰𝚁 𝚂𝚄 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙾 𝚄𝚂𝙰𝙽𝙳𝙾 ${usedPrefix}unreg*`}
const smsVerify9 = () => { return `𝙸𝙽𝚂𝙸𝙶𝙽𝙸𝙰 𝚅𝙴𝚁𝙸𝙵𝙸𝙲𝙰𝙳𝙾`}
...
//config-on y off.js
const smsConfi1bot = () => { return `⚙️ *CONFIGURACIÓN ON-OFF* ⚙️`}
const smsConfi2bot = () => { return `𝐂𝐎𝐌𝐀𝐍𝐃𝐎`}
const smsConfi3bot = () => { return `𝐄𝐒𝐓𝐀𝐃𝐎`}
const smsConfi4bot = () => { return `𝐏𝐀𝐑𝐀`}
...
//_allantilink.js 
const smsTextoYT = () => { return 'NANI BOT ✅ - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*NO TIENES DIAMANTES!! 💎 PUEDE IR A LA TIENDA CON EL COMANDO*`}
...
const smsAutodetec6 = (inf, m, groupMetadata, usuario) => { return `${inf}*@${m.messageStubParameters[0].split`@`[0]} NUEVO ADMIN EN*\n*» ${groupMetadata.subject}*\n\n➤ *ACCIÓN HECHA POR:*\n*» ${usuario}*`} 
